...
import 'package:doctor_consultation/feature/ai/ai_chat/view/screen/ai_chat_screen.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: RadialGradient(
          ...
          colors: [Colors.tealAccent.withValues(alpha: 0.2), Colors.white],
        ),
      ),
      child: Scaffold(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Get.to(
                              () => VideoDetailScreen(initialIndex: index),
                            );
                          },
                          child: Container(
                            width: 140,
